...
class controleurHomeAccueil extends controleur {
	...
	public function setDonnees() {
		...
		// ===============================================================================================================
		//$this->enteteLien = "<link rel='stylesheet' type='text/css' href='./librairie/slidesjs/css/slidejs.css' />\n
							//<script type='text/javascript' src='./librairie/slidesjs/js/slidejs.js'></script>\n";
							
		$this->enteteLien = $this->IntLien("slidejs");
