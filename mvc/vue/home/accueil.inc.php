		...
		<div id="example">
			<div id="slides">
				...
				<a href="#" class="prev">
					<img alt="Arrow Prev"
						 id="ArrowPrev"
						 src="./librairie/slidejs/img/arrow-prev.png"
						 width="24"
						 height="43"
						 onmouseover="window.document.getElementById('ArrowPrev').src='./librairie/slidejs/img/arrow-prev-hover.png'"
						 onmouseout="window.document.getElementById('ArrowPrev').src='./librairie/slidejs/img/arrow-prev.png'" />
				</a>
				<a href="#" class="next">
					<img alt="Arrow Next"
						 id="ArrowNext"
						 src="./librairie/slidejs/img/arrow-next.png"
						 width="24"
						 height="43"
						 onmouseover="window.document.getElementById('ArrowNext').src='./librairie/slidejs/img/arrow-next-hover.png'"
						 onmouseout="window.document.getElementById('ArrowNext').src='./librairie/slidejs/img/arrow-next.png'" />
				</a>
			</div>
		</div>
	</div>
