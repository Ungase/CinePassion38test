 ...
 */
 function chargerClasse($classe) {
	...
	if (file_exists("./framework/class." . $classe . ".inc.php")) {
		...
		if (count($tab) == 2){
		    $nomFichier ="commun";
		    require_once "./mvc/modele/".mb_strtolower($tab[1])."/". $nomFichier.".inc.php";
		}Else{
		    if(file_exists("./mvc/modele/" . strtolower($tab[1]) . "/" . strtolower($tab[2]) . ".inc.php")){
